    ...
    <div class="d-flex h-full rounded bg-white p-5 pt-3 mt-3 d-flex flex-column" style="max-height: 88vh;">
      <form id="newForms" onsubmit="submitForm(event)">
        <div class="row form-outline mt-3">
          ...
          <div class="col-11">
            <input type="text" class="form-control form-control-lg" placeholder="{{ __('lang.username') }}" name="username" />
          </div>
        </div>
        <div class="row form-outline mt-3">
          <div class="col-1 d-flex justify-content-end align-items-center pe-3">
          ...
          <div class="col-11">
            <input type="password" class="form-control form-control-lg" placeholder="{{ __('lang.password') }}" name="password" />
          </div>
        </div>
        <div class="row form-outline mt-3">
          <div class="col-1 d-flex justify-content-end align-items-center pe-3">
          ...
          <div class="col-11">
            <input type="password" class="form-control form-control-lg" placeholder="{{ __('lang.confirmPassword') }}" name="confirmPassword" />
          </div>
        </div>
        <div class="row form-outline mt-3">
          <div class="col-1 d-flex justify-content-end align-items-center pe-3">
